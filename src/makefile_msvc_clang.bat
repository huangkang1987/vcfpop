...
set "FLAG=/c /D_HAS_EXCEPTIONS=0 /MP /MP8 /TP /w /W0 /WX- /nologo /I"." /Zc:wchar_t /Zc:inline /Ox /Ob2 /Oi /Ot /Oy /GL /GF /Gm- /MT /GS- /Gy /GR- /Qpar /arch:SSE2 /fp:precise /fp:except- /DNDEBUG /DCUDA /DCUDA_NDEBUG /DENABLE_RELATEDNESS /D_CONSOLE /D_UNICODE /DUNICODE /std:c++20 /openmp -msse3 -msse4.1 -msse4.2 -mlzcnt -mpopcnt -Wwritable-strings"
...
::compile CUDA code
start /min /b nvcc.exe -dlink -keep -I="." -DCUDA -DCUDA_NDEBUG structureCUDA.cu -w -O3 -m64 --gpu-architecture=sm_60 -Xcompiler "/EHsc /nologo /Zi"

clang-cl.exe %FLAG% ml2.cpp

::link
clang-cl.exe /Fe:vcfpop.msvc.clang.exe -MT -DSFML_STATIC vcfpop.obj dre.obj ml.obj ml2.obj mlbin.obj mom.obj mom2.obj global.obj hash.obj math2.obj mathNEO.obj mathSSE.obj mathAVX.obj math512.obj parameters.obj misc.obj file.obj string2.obj statistics.obj matrix.obj spa.obj ploidyinfer.obj function.obj load.obj filter.obj diversity.obj haplotype.obj conversion.obj indstat.obj dist.obj pcoa.obj clustering.obj diff.obj kinship.obj relatedness.obj amova.obj popas.obj structure.obj structureNEO.obj structureSSE.obj structureAVX.obj structure512.obj structureCUDA.obj a_dlink.obj ad.obj menu.obj cudart.lib zlibstat.lib kernel32.lib libomp.lib /link %LIBDIR%
